...
<td style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoj', 'Segoe UI Symbol'; box-sizing: border-ibox; color: #74787e; font-size: 15px; line-height: 18px; padding: 10px 0; margin: 0;">{{$ticket->type->name}}</td>
</tr>
<tr>
