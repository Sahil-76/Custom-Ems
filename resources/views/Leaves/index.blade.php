            ...
            <div class="info-box border border-primary">
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                        <a href="{{ route('leave.request', array_merge(['waiting' => 1], request()->all())) }}">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                {!! Form::label('emp_id', 'Search Employee ID') !!}
                                {!! Form::text('emp_id', request()->emp_id ?? null, [
                                    'class' => 'form-control',
                            ...
                            @foreach ($leaves as $leave)
                                ...
                                <tr @if ($leave->status == 'Rejected') class="bg-red" @endif>
                                    ...
                                    @elseif(auth()->user()->hasRole('Leave Admin') && $responsibleArray['approval_role'] == 'Leave Admin')
                                        <a href="{{ route('leave.show', $leave->id) }}"
                                                class="btn btn-primary">Action</a>
                                    @elseif(auth()->user()->hasRole('Sales Senior Manager') &&
                                            $leave == 'Pending' &&
                                            $responsibleArray['approval_role'] == 'Sales Senior Manager')
                                        <a href="{{ route('leave.show', $leave->id) }}"
                                                class="btn btn-primary">Action</a>
                                    @else
                                        <a href="{{ route('leave.show', $leave->id) }}"
